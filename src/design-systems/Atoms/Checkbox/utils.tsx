...
export const getBackgroundStyles = (disabled = false, checked = false) => {
  ...
  if (checked) {
    return 'fill-neutral-100 dark:fill-neutral-800 group-hover:fill-neutral-400 dark:group-hover:fill-neutral-800'
  } else {
    return 'fill-transparent dark:fill-neutral-400 dark:group-hover:fill-neutral-500'
  }
}
